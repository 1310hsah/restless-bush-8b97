...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/restless-bush-8b97
```

A live public deployment of this template is available at [https://restless-bush-8b97.templates.workers.dev](https://restless-bush-8b97.templates.workers.dev)
